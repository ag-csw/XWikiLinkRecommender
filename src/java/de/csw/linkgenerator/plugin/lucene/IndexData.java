...
//        }
    ...
    /**
     * @return String of documentName, documentWeb, author and creator, document title, sections titles
     * and similar terms from the ontology.
     */
    ...
    /**
     * Gets data like title, section titles etc.
     * @return
     */
    public abstract String getRelevantData(XWikiDocument doc, XWikiContext context);
